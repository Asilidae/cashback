...
from app.modules.sber_extract.utils import get_float_from_money
from app.modules.sber_extract.utils import split_Sberbank_line

from app.modules.sber_extract.extractor import Extractor

import app.modules.sber_extract.extractors_generic
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        extractors_generic.debug_extractor(SBER_SAVING_2407,
